export const neighbours = {
    ...
    'Babək': ['Kəngərli', 'Şahbuz', 'Culfa', 'Naxçıvan'], 
    'Balakən': ['Zaqatala'], 
    ...
    'Kəlbəcər': ['Daşkəsən', 'Göygöl', 'Goranboy', 'Tərtər', 'Ağdam', 'Xocalı', 'Laçın'], 
    'Kəngərli': ['Şərur', 'Babək'], 
    'Kürdəmir': ['Hacıqabul', 'Sabirabad', 'İmişli', 'Zərdab', 'Ucar', 'Göyçay', 'İsmayıllı', 'Ağsu'], 
    'Laçın': ['Kəlbəcər', 'Xocalı', 'Şuşa', 'Xocavənd', 'Qubadlı'], 
    ...
    'Qubadlı': ['Laçın', 'Zəngilan', 'Xocavənd', 'Cəbrayıl'], 
    ...
    'Zəngəzur dəhlizi': ['Zəngilan', 'Ordubad']
    };
